...
const GenerateSalesReport = ({ isOpen, onClose,  }) => {
    ...
    const handleGenerateReport = async () => {
        ...
        try {
            setIsLoading(true);
            const response = await axiosAdminInstance.post("generate-sales-reports/",
                    ...
                    <div className="p-4 md:p-5 space-y-4">
                        ...
                        <div className="flex justify-center pt-4">
                            <button
                               ...
                               disabled={isLoading}
                               className={`mt-2 bg-gray-600 w-1/2 text-white py-2 px-4 rounded hover:bg-gray-800 transition-all duration-300 ${isLoading ? 'cursor-notallowed opacity-70': ''}`}
                            >
                                 {isLoading ? (
