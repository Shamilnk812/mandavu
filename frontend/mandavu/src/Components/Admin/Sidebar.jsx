...
export default function Sidebar() {
  ...
  return (
    <>
      ...
      <nav class="fixed top-0 z-50 w-full bg-white shadow-sm border-b border-gray-200">
          ...
          <div class="flex items-center justify-between">
            <div class="flex items-center justify-start rtl:justify-end">
              ...
              <a class="flex ms-2 md:me-24">
                <span class="self-center text-xl font-semibold sm:text-xl whitespace-nowrap text-gray-700"><AdminPanelSettingsIcon fontSize="large"/> Admin</span>
              </a>
            </div>
            ...
            <ul class="py-1" role="none">
              <li>
                <a href="#" class="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100 dark:text-white-300 dark:hover:bg-gray-600 dark:hover:text-white" role="menuitem"></a>
              </li>
              <li>
      ...
      className={`fixed top-0 left-0 z-40 w-64 h-screen pt-20 transition-transform ${sidebarOpen ? 'translate-x-0' : '-translate-x-full'} bg-white border-r border-gray-200 md:translate-x-0 dark:bg-gray-800 dark:border-gray-700" aria-label="Sidebar`}
      >
