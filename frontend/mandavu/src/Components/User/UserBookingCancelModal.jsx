...
const UserBookingCancelModal = ({isModalOpen, handleCloseModal, handleFormSubmit, setCancelReason, cancelReason})=> {
                            ...
                            <div className="p-4 md:p-5">
                                <form className="space-y-4" onSubmit={handleFormSubmit}>
                                    ...
                                    <div className="flex justify-center pt-4">
                                        <button type="submit" className="w-1/2 mt-2 bg-gray-800 text-white py-2 px-4 rounded hover:bg-gray-600  transition-all duration-300">Submit</button>
                                    </div>
                                </form>
                            </div>
                        </div>
