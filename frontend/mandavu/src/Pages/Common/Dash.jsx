...
export default function Dash() {
  ...
  <div class="py-12 px-12 bg-white rounded-2xl shadow-xl z-20">
    ...
    <div class="text-center mt-6">
      <button class="w-full py-2 text-xl text-white bg-teal-500 rounded-lg hover:bg-teal-600 transition-all" onClick={()=>navigate('/user/signup')}>Create Account</button>
      <p class="mt-4 text-sm">Already Have An Account? <span class="underline  cursor-pointer"> <Link to={"/user/login"}>Login</Link></span></p>
    </div>
  </div>
  <div class="py-12 ml-10 px-12 bg-white rounded-2xl shadow-xl z-20">
    <div>
